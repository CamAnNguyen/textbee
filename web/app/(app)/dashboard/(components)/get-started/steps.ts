...
export const STEPS: StepDef[] = [
  ...
  },
  {
    ...
    description: 'Install IDGroup on the Android phone that will send your SMS.',
  ...
  },
  {
    ...
    description: 'Turn your phone into your SMS gateway: scan the QR code below with the IDGroup app.',
