  ...
  private async assertDeviceLimitNotReached(
    ...
    if (activeDeviceCount >= deviceLimit) {
      ...
      throw new HttpException(
        {
          message: `Active device limit reached: your plan allows up to ${deviceLimit} active device(s) and you have ${activeDeviceCount}. Disable or delete another device, or upgrade your plan at https://sms.tainhamassage.com/dashboard`,
