...
export const API_TAGS: ReadonlyArray<{ name: string; description: string }> = [
  ...
  },
  {
    name: 'webhooks',
    description:
      'Subscribe to SMS events and inspect the delivery attempts IDGroup made for them.',
  },
  {
    name: 'auth',
    description:
      'Accounts, sessions, and API keys. Used by the IDGroup dashboard.',
  },
  {
    name: 'billing',
...
const LICENSE = {
  name: 'MIT',
  url: 'https://github.com/CamAnNguyen/textbee/blob/main/LICENSE',
} as const
    ...
    .addApiKey(
      {
        ...
        in: 'header',
        description:
          'API key from your IDGroup dashboard, sent on every request.',
      },
